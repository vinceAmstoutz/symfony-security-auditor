...
| --------------------- | ----- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `--format`            | `-f`  | `console`  | Output format: `console` (human-readable), `json`, `sarif`, `html` (self-contained, HTML-escaped report for sharing or archiving), or `markdown` (GitHub-flavored report for a PR comment or `$GITHUB_STEP_SUMMARY`)                                                                                                                                                                                                                                   |
