...
| Key                                         | Type        | Default | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ------------------------------------------- | ----------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `scan.excluded_dirs`                        | `string[]`  | `[]`    | Extra directories to skip. **Appended** to the hard defaults (`vendor`, `node_modules`, `.git`, `.github`, `.idea`, `.vscode`, `var/cache`, `var/log`, `public/bundles`, `public/build`, `tests`, `Tests`, `migrations`, `Migrations`, `translations`, `build`, `coverage`); never replaces them. The default list keeps audits focused on deployable application source — test code, generated migrations, translations, and build artefacts are not scanned. |
