...
> [!WARNING] **Security audit reports contain a list of vulnerabilities in your
...
> [!TIP] Schedule the audit as a nightly CI job — the multi-agent LLM loop can
> take minutes, so blocking PRs on it hurts productivity. See
