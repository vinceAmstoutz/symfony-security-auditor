...
final class ProjectFileTest extends TestCase
{
    ...
    {
        $projectFile = SymfonyProjectFile::create('README.md', '/app/README.md', '# Docs');
    ...
    public function test_it_throws_on_empty_relative_path(): void
    {
        ...
        SymfonyProjectFile::create(relativePath: '  ', absolutePath: '/app/file.php', content: '<?php');
    }
    ...
    public function test_it_detects_file_types_correctly(
        ...
        $projectFile = SymfonyProjectFile::create($path, '/app/'.$path, '<?php');
    ...
    {
        $projectFile = SymfonyProjectFile::create('src/Controller/Homepage.php', '/app/src/Controller/Homepage.php', '<?php');
    ...
    {
        $projectFile = SymfonyProjectFile::create('src/Controller/config.yaml', '/app/src/Controller/config.yaml', 'foo: bar');
    ...
    {
        $projectFile = SymfonyProjectFile::create('src/Service/PaymentService.php', '/app/src/Service/PaymentService.php', '<?php class PaymentService { public function charge() {} }');
    ...
    {
        $projectFile = SymfonyProjectFile::create('src/Form/UserType.php', '/app/src/Form/UserType.php', '<?php');
    ...
    {
        $projectFile = SymfonyProjectFile::create('src/Security/Voter/Access.php', '/app/src/Security/Voter/Access.php', '<?php');
    ...
    {
        $projectFile = SymfonyProjectFile::create('src/Repository/UserStore.php', '/app/src/Repository/UserStore.php', '<?php');
    ...
    {
        $projectFile = SymfonyProjectFile::create('src/Service/Mailer.php', '/app/src/Service/Mailer.php', '<?php class Mailer { public function send() {} }');
    ...
    {
        $projectFile = SymfonyProjectFile::create('config/security.yaml', '/app/config/security.yaml', 'security:');
    ...
    {
        $projectFile = SymfonyProjectFile::create('.env.dev', '/app/.env.dev', 'APP_ENV=dev');
        self::assertSame('config', $projectFile->type());
    }
    ...
    {
        $projectFile = SymfonyProjectFile::create('.env.local.php', '/app/.env.local.php', '<?php return [];');
    ...
    public function test_it_detects_security_annotations(): void
    {
        ...
        $withoutAnnotation = SymfonyProjectFile::create(
    ...
    {
        $projectFile = SymfonyProjectFile::create('src/Repo.php', '/app/src/Repo.php', '<?php $conn->query($input);');
    ...
    {
        $projectFile = SymfonyProjectFile::create('src/Service/FooService.php', '/app/src/Service/FooService.php', '<?php');
        self::assertTrue($projectFile->isService());
    }
    ...
    {
        $projectFile = SymfonyProjectFile::create('src/Controller/FooController.php', '/app/src/Controller/FooController.php', '<?php');
    ...
    {
        $projectFile = SymfonyProjectFile::create('src/Entity/Foo.php', '/app/src/Entity/Foo.php', '<?php');
        self::assertFalse($projectFile->isService());
    }
    ...
    {
        $projectFile = SymfonyProjectFile::create('src/Security/FooVoter.php', '/app/src/Security/FooVoter.php', '<?php');
        self::assertFalse($projectFile->isService());
    }
    ...
    {
        $projectFile = SymfonyProjectFile::create('src/Repository/FooRepository.php', '/app/src/Repository/FooRepository.php', '<?php');
        self::assertFalse($projectFile->isService());
    }
    ...
    {
        $projectFile = SymfonyProjectFile::create('src/Form/FooType.php', '/app/src/Form/FooType.php', '<?php');
        self::assertFalse($projectFile->isService());
    }
    ...
    {
        $projectFile = SymfonyProjectFile::create('templates/foo.twig', '/app/templates/foo.twig', '{{ foo }}');
        self::assertFalse($projectFile->isService());
    }
    ...
    {
        $projectFile = SymfonyProjectFile::create('src/Dto/UserType.php', '/app/src/Dto/UserType.php', '<?php');
        self::assertFalse($projectFile->isForm());

        $withDirNoSuffix = SymfonyProjectFile::create('src/Form/UserHandler.php', '/app/src/Form/UserHandler.php', '<?php');
    ...
    {
        $projectFile = SymfonyProjectFile::create('src/Entities/User.php', '/app/src/Entities/User.php', '<?php');
        self::assertTrue($projectFile->isEntity());
    }
    ...
    {
        $projectFile = SymfonyProjectFile::create('config/services.yml', '/app/config/services.yml', '');
        self::assertTrue($projectFile->isConfiguration());

        $xml = SymfonyProjectFile::create('config/services.xml', '/app/config/services.xml', '');
    ...
    {
        $projectFile = SymfonyProjectFile::create('config/security.yaml', '/app/config/security.yaml', '');
        self::assertTrue($projectFile->isConfiguration());
    }
    ...
    {
        $projectFile = SymfonyProjectFile::create('config/services.xml', '/app/config/services.xml', '');
        self::assertSame('config', $projectFile->type());
    }
    ...
    {
        $projectFile = SymfonyProjectFile::create('a.php', '/app/a.php', '<?php echo "hello";');
        $b = SymfonyProjectFile::create('b.php', '/app/b.php', '<?php echo "hello";');
    ...
    {
        $projectFile = SymfonyProjectFile::create('a.php', '/app/a.php', '<?php echo "hello";');
        $b = SymfonyProjectFile::create('b.php', '/app/b.php', '<?php echo "world";');
    ...
    {
        $projectFile = SymfonyProjectFile::create('a.php', '/app/a.php', 'x');
