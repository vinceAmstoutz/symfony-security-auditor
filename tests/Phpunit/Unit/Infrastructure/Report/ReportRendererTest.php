...
final class ReportRendererTest extends TestCase
{
    ...
    public function test_render_console_header_includes_the_project_homepage_url(): void
    {
        $output = $this->reportRenderer->renderConsole($this->makeReport());
    ...
    public function test_render_console_homepage_url_is_inside_double_bar_frame(): void
    {
        $output = $this->reportRenderer->renderConsole($this->makeReport());
        $frame = str_repeat('═', 70);
        $firstFrame = strpos($output, $frame);
    ...
    public function test_render_sarif_driver_information_uri_is_the_project_homepage(): void
    {
        $decoded = $this->decodeSarif($this->makeReport());
    ...
    public function test_render_html_footer_links_to_the_project_homepage(): void
    {
        $output = $this->reportRenderer->renderHtml($this->makeReport());
    ...
    public function test_render_markdown_footer_links_to_the_project_homepage(): void
    {
        $output = $this->reportRenderer->renderMarkdown($this->makeReport());
