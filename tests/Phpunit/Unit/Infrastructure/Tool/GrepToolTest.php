        ...
        self::assertSame(
            [
                ...
                'properties' => [
                    ...
                    'file_type' => [
                        'type' => 'string',
                        'description' => 'Optional ProjectFile::type() to restrict the search to: controller, api_resource, live_component, entity, voter, repository, form, authenticator, ldap_service, sonata_admin, messenger_handler, webhook_consumer, event_subscriber, normalizer, scheduler, twig_extension, template, config, php, other.',
                    ],
                ],
                'required' => ['pattern'],
            ],
