...
use VinceAmstoutz\SecurityAuditor\Audit\Infrastructure\SelfUpdate\Exception\UnsupportedSelfUpdatePlatformException;
use VinceAmstoutz\SecurityAuditor\Audit\Infrastructure\SelfUpdate\GitHubBinaryAsset;
use VinceAmstoutz\SecurityAuditor\Audit\Infrastructure\SelfUpdate\GitHubBinaryAssetResolver;
...
use VinceAmstoutz\SecurityAuditor\Audit\Infrastructure\SelfUpdate\RunningBinaryLocatorInterface;
use VinceAmstoutz\SecurityAuditor\Audit\Infrastructure\SelfUpdate\SelfUpdater;
...
final class SelfUpdaterTest extends TestCase
{
    ...
    private function selfUpdater(ReleaseClientInterface $releaseClient, ?string $binaryPath = null, ?Filesystem $filesystem = null, ?PricingCatalogRefresherInterface $pricingCatalogRefresher = null): SelfUpdater
    {
        ...
        return new SelfUpdater($releaseClient, new GitHubBinaryAssetResolver('Linux', 'x86_64'), $locator, $this->pendingBinarySwap, $filesystem ?? new Filesystem(), $pricingCatalogRefresher ?? new NullPricingCatalogRefresher());
    }
}
