...
namespace VinceAmstoutz\SecurityAuditor\Audit\Infrastructure\LLM\TokenEstimator;
...
final readonly class MiniMaxTokenEstimator implements ProviderTokenEstimatorInterface
{
    ...
    {
        return u($model)->ignoreCase()->startsWith('minimax');
    }
