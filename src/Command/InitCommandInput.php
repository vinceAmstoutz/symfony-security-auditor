...
final class InitCommandInput
{
    ...
    #[Option(description: 'Base URL of the platform endpoint, for instance-keyed platforms that expose one (generic, openresponses, azure). Skips the prompt when set.', name: 'base-url')]
