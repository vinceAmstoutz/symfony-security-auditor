    ...
    public static function fromArray(array $config): self
    {
        ...
        return new self(
            ...
            audit: new AuditExecutionConfiguration(
                ...
                sinceClosure: $config['audit']['since_closure'] ?? 'none',
            ),
