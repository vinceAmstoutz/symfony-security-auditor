    ...
    public static function fromArray(array $config): self
    {
        ...
        return new self(
            ...
            audit: new AuditExecutionConfiguration(
                ...
                fixSynthesisEnabled: $config['audit']['fix_synthesis']['enabled'],
                fixSynthesisSeverityFloor: $config['audit']['fix_synthesis']['severity_floor'],
