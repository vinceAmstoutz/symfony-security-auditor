...
final readonly class ReviewerPromptSections implements ReviewerPromptSectionsInterface
{
    ...
    {
        return self::SEVERITY_RUBRIC;
    }

    #[Override]
    public function falsePositivePlaybook(): string
    {
        return self::FALSE_POSITIVE_PLAYBOOK;
    }

    #[Override]
    public function jsonSchemaDescription(): string
    {
        return self::JSON_SCHEMA_DESCRIPTION;
    }
    ...
    {
        return self::TOOL_USAGE_DISCIPLINE;
    }

    #[Override]
    public function structuredOutputContract(): string
    {
        return self::STRUCTURED_OUTPUT_CONTRACT;
    }

    #[Override]
    public function structuredDecisionRules(): string
    {
        return self::STRUCTURED_DECISION_RULES;
    }
}
