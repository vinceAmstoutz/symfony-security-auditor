...
src/
  Audit/
    ...
    Infrastructure/  # I/O adapters
      ...
      Report/        # ReportRendererInterface (format/render) + one class per format ({Console,ExecutiveSummary,Json,Sarif,Html,Markdown,Junit,GithubAnnotations}ReportRenderer) + ReportPackage + TemplateLoader; + Template/*.txt + *.html stubs
