...
| Static analysis   | PHPStan max + phpstan-strict-rules + custom rules (`FinalRule`, `MaxParameterCountRule`, `NoEmptyCatchRule`, `NoSilencingErrorHandlerRule`, `ForbiddenTestAttributeRule`, `SprintfOverConcatRule`, `OversizedDocblockRule` (docblock prose capped at 12 lines, annotations exempt — the `.claude/rules/no-comments.md` gate) — in `tools/PHPStan/`) + symplify/spaze rules + Rector                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
