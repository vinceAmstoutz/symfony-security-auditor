...
src/
  Audit/
    ...
    Application/     # Orchestration — no I/O, depends only on Domain
      ...
      Pipeline/      # AuditPipeline + Stage/{IngestionStage, MappingStage, AuditStage, PoCSynthesisStage, FixSynthesisStage}
